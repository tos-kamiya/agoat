...
class AndOrTreeTest(unittest.TestCase):
    ...
    def test_normalize_tree_len2(self):
        ...
        self.normalize_testing(
            [at.ORDERED_OR, 'b', 'a'], [at.ORDERED_OR, 'a', 'b'])
    ...
    def test_normalize_tree_dep2_len1_len1(self):
        self.normalize_testing(
            [at.ORDERED_AND, 'a', [at.ORDERED_AND, 'b']], [at.ORDERED_AND, 'a', 'b'])
        self.normalize_testing(
            [at.ORDERED_AND, 'a', [at.ORDERED_OR, 'b']], [at.ORDERED_AND, 'a', 'b'])
        self.normalize_testing(
            [at.ORDERED_OR, 'a', [at.ORDERED_AND, 'b']], [at.ORDERED_OR, 'a', 'b'])
        self.normalize_testing(
            [at.ORDERED_OR, 'a', [at.ORDERED_OR, 'b']], [at.ORDERED_OR, 'a', 'b'])

    def test_normalize_tree_dep2_len1_len0(self):
        self.normalize_testing([at.ORDERED_AND, 'a', [at.ORDERED_AND]], 'a')
        self.normalize_testing(
            [at.ORDERED_AND, 'a', [at.ORDERED_OR]], [at.ORDERED_OR])
        self.normalize_testing(
            [at.ORDERED_OR, 'a', [at.ORDERED_AND]], SameAsInput)
    ...
    def test_normalize_tree_item_order_in_or_node(self):
        self.normalize_testing(
            [at.ORDERED_OR, 'a', [at.ORDERED_AND]], SameAsInput)
        self.normalize_testing(
            [at.ORDERED_OR, [at.ORDERED_AND], 'a'], [at.ORDERED_OR, 'a', [at.ORDERED_AND]])

    def test_normalize_tree_of_various_item_type(self):
        for item in ('a', 1, None, (), [], (1,), [1]):
            self.normalize_testing(
                [at.ORDERED_AND, item, [at.ORDERED_AND]], item)
            self.normalize_testing(
                [at.ORDERED_AND, item, [at.ORDERED_OR]], [at.ORDERED_OR])
            self.normalize_testing(
                [at.ORDERED_OR, item, [at.ORDERED_AND]], SameAsInput)
            self.normalize_testing(
                [at.ORDERED_OR, item, [at.ORDERED_OR]], item)
