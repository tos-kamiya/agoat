...
class JimpCodeTransformerTest(unittest.TestCase):
    def test_paths_to_ordred_andor_tree_simple(self):
        ...
        tree = jct.paths_to_ordred_andxor_tree(paths)
        expected = [jct.ORDERED_AND, '1', '2', [jct.ORDERED_XOR, '3', [jct.ORDERED_AND]]]
    ...
    def test_paths_to_ordred_andor_tree_simple2(self):
        ...
        tree = jct.paths_to_ordred_andxor_tree(paths)
        expected = [jct.ORDERED_AND, '1', [jct.ORDERED_XOR, '2', [jct.ORDERED_AND]], '3']
        self.assertEqual(tree, expected)

    def test_paths_to_ordred_andor_tree_complex(self):
        paths = map(str_to_char_list, ["12345", "135", "123a5"])
        tree = jct.paths_to_ordred_andxor_tree(paths)
        expected = [jct.ORDERED_AND, '1', [jct.ORDERED_XOR, '3', [jct.ORDERED_AND, '2', '3', [jct.ORDERED_XOR, '4', 'a']]], '5']
        self.assertEqual(tree, expected)
